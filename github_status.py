# Note: This file is taken from the development branch for Buildbot 0.9.0.
# txgithub is required for this status to work. For documentation refer to
# https://github.com/buildbot/buildbot/blob/nine/master/docs/manual/cfg-statustargets.rst#githubstatus
